...
export const featured = {
  ...
  media: asset("assets/projects/carecation.mp4"),
...
const raw = [
  { title: "DraftKings NBA Optimizer", blurb: "Pulls the live DraftKings slate and ranks players by a transparent points-per-dollar metric. A built-in AI analyst proposes the best cap-legal, position-legal swap for any slot — with reasoning. Classic & Showdown support.", media: "assets/projects/nba-optimizer.mp4", tech: ["nextjs", "typescript", "tailwind", "python", "ai"], live: "https://draftkings-optimizer.vercel.app/", code: "https://github.com/capisz/draftkings-optimizer", status: "complete", ai: true },
  { title: "backstop.ai", blurb: "A public-data baseball product that grades catcher pitch-calling in real time from the MLB Stats API. One click streams a Claude analyst's grounded read of each catcher's live zone report.", media: "assets/projects/catcher-ai.mp4", tech: ["nextjs", "typescript", "fastapi", "python", "postgres", "claude"], live: "https://ai-catcher-grade-app-web.vercel.app/", code: "https://github.com/capisz/ai-catcher-grade-app", status: "complete", ai: true },
  ...
  { title: "Pokémon Prize Checker", blurb: "A tool to simulate and perfect your Pokémon TCG prize-checking without physical cards — any time, any place, zero setup.", media: "assets/projects/pokemonshuffle.mp4", tech: ["nextjs", "react", "typescript", "api", "tailwind", "mongodb"], live: "https://prizecheck.us/", code: "https://github.com/capisz/pokemon-tcg-prize-checker", status: "complete" },
  { title: "Dragapultist", blurb: "Import your Pokémon TCG Live export files to analyze your games, spot mistakes, and improve as a competitive player.", media: "assets/projects/dragapultist.mp4", tech: ["nextjs", "react", "mongodb", "typescript", "tailwind", "node"], live: "https://dragapultist.vercel.app/", code: "https://github.com/capisz/dragapultist", status: "complete" },
