...
const groups = {
  ...
  'Tools & infrastructure': ['GitHub Actions','Xcode','Figma','Vite.js','Ubuntu','Linux','Kubernetes','Docker','kind','Claude AI','Google Gemini','Cursor AI','Codex','Postman','SVG Viewer'],
};
