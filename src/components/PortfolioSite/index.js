...
const groups = {
  ...
  'Tools & infrastructure': ['GitHub Actions','GitHub','Xcode','Visual Studio','Figma','Canva','Vite.js','Ubuntu','Linux','Kubernetes','Docker','AWS','Lambda','Webhooks','Vercel','Cloudflare','kind','Git','Claude AI','Google Gemini','Cursor AI','Codex','Postman'],
};
