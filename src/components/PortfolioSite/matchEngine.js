...
export function matchProjects(input) {
  ...
  return {requested, requestedRoles, status, best, suggestion, alternatives:candidates.slice(1,5), explanation:explanation+' Tech Alignment is an estimate: evidenced skills count twice as much as gaps, capped at 95%. It is not literal coverage, hiring probability or overall qualification. Equal evidence is ordered by role relevance, then project title.'};
}
