...
const demos = {
  PrizeCheck: 'prizecheck',
  'DraftKings NBA Optimizer': 'draftkings',
  'Amazon Room Generator': 'room-generator',
  FunkFit: 'funkfit',
  CareCation: 'carecation',
  'backstop.ai': 'backstop',
  ParkNYC: 'parknyc',
  'Contessa Shop': 'contessa',
  'Concrete Jungle Sports': 'nba-blog',
  'Hudson Chess': 'hudson-chess',
  Dragapultist: 'dragapultist',
  'Chess Opening Driller': 'chess-driller',
};
