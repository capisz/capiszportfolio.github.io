...
test('typing, badge hold and landing finish before welcome and input',()=>{
 ...
 for(const [phase,duration] of [['knight',2200],['greetingOut',700],['badges',3200],['departing',700],['welcome',2400],['revealing',500]]){
...
test('scroll cannot truncate typing or landing and preserves a readable badge hold',()=>{
 ...
 act(()=>jest.advanceTimersByTime(700));expect(result.current.phase).toBe('badges');
